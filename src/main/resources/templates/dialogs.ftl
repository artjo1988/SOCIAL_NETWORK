            ...
            <div class="flexItem infoCollumnUsers">
                <div class="white-bg dopBlock">
                    <div style="border-bottom: 2px solid rgba(202, 194, 199, 0.96); margin: -5px 0 10px 0; padding: 0 0 8px 0 ">
                        <div style="font-size: 25px">Диалоги</div>
                    </div>
                <#--<#if chats??>-->
                    <#--<#list chats as chat>-->
                        <#--<div  style="margin-bottom: 15px ; display: block">-->
                            <#--<div style="display: flex;">-->
                                ...
                                <#--<div style="padding: 30px; margin-left: 200px;">-->
                                    <#--<#if user.role == "ADMIN">-->
                                        <#--<a href="" class="btn btn-purple w-md">Открыть диалог</a>-->
                                    <#--<#else>-->
                                        <#--<a href="/chats/?id=${chat.id}" class="btn btn-purple w-md">Открыть диалог</a>-->
                                    <#--</#if>-->
                                <#--</div>-->
                            <#--</div>-->
                        <#--</div>-->
                ...
                <#if chats??>
                    ...
                    <div style="display: block">
                        <div style="display: flex; justify-content: space-between">
                            ...
                            <div style="padding: 25px 40px 0 20px" >
                                <a href="/chats/?id=${chat.id}" class="btn btn-purple w-md">Открыть диалог</a>
                            </div>
                        </div>
                    </div>
