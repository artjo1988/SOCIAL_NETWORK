...
<html lang="en">
    ...
    <body background="/img/background.jpg" no-repeat style="background: cover; ">
        <div class="wrapper-page animated fadeInDown">
            <div class="panel panel-color panel-primary">
                <div class="panel-heading"> 
                   <h3 class="text-center m-t-10">Социальная сеть <strong>"Друзья"</strong> </h3>
                </div>
                <div class=form-horizontal m-t-30 text-center">
                    <div class="form-group m-t-30 text-center">
                        <div class="col-xs-12">
                            <a href="/login" class="btn btn-primary w-md" >Войти</a>
                        </div>
                    </div>
                    <div align="center">или</div>
                    <div class="form-group m-t-20 text-center">
                        <div class="col-xs-12">
                            <a href="/register" class="btn btn-primary w-md" >Зарегистрироваться</a>
                        </div>
                    </div>
                 </div>
            </div>
