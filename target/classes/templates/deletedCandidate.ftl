        ...
        <div class="flexWrap profileBlock">
            ...
            <div class="flexItem avatarCollumn">
                ...
                <div class="avatarUsers tile-stats white-bg">
                    ...
                    <a href="#" class="btn btn-purple w-md" style="margin-top: 7px; margin-right: 10px"> Хочешь написать?!) <span style="margin-left: 7px" class="ion-chatbubbles"></span></a>
                    <#--<span class="btn btn-purple w-md" style="margin-top: 7px;">-->
                        ...
                        <#elseif status == "На Вас подписан">
                            <span class="btn btn-purple w-md" style="margin-top: 7px;">
                            <a  class="dropdown-toggle" href="#" class="btn btn-purple w-md" style="margin-top: 7px;"><span style="color: white"> ${status} </span>
                        ...
                        <#elseif status == "Добавить в друзья">
                            <span class="btn btn-purple w-md" style="margin-top: 7px;">
                            <a  href="#" ><span style="color: white"> Попробуй нажать!) </span></a>
                            </span>
                        </#if>
                    <#--</span>-->
                </div>
            ...
            <div class="flexItem infoCollumn">
                ...
                <div class="user-information tile-stats white-bg">
                    ...
                    <hr style=" border: 1px solid rgba(202, 194, 199, 0.96);">
                    <H4>Страница удалена</H4>
                        <a href="/profile/friends" style="margin-left: 230px; margin-top: 40px;" class="btn btn-purple w-md">Вернуться к друзьям</a>
